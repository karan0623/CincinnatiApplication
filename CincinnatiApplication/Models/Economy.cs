...
public enum ProgramType { BelowMarketRateSale, CapitalGrant, CdbgGrant, Cra, DistrictTif, Focus52, Grant, GrossLease, GrowCincinnatiLoanFund, Home, Jctc, LandSale, Lease, LeedCra, Loan, Multiple, OtherCityGrant, OtherCityLoan, Pir, ProjectTif, Tif, TifGrant, TripleNetLease }; public enum ProjectCategory { CommercialTaxAbatement, Grant, LeaseOfCityProperty, Loan, SaleOfCityProperty, TaxIncentive, TaxIncrementFinancing }; public enum ProjectType { Commercial, Hotel, Industrial, Infrastructure, MixedUse, Office, Other, ProjectTypeIndustrial, ProjectTypeMixedUse, ProjectTypeOffice, ProjectTypeResidential, PublicInfrastructure, Residential, Retail, Undetermined }; public partial class Welcome
    {
...
internal class ParseStringConverters : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(long) || t == typeof(long?); public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
    ...
    {
        public override bool CanConvert(Type t) => t == typeof(ProgramType) || t == typeof(ProgramType?); public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            if (reader.TokenType == JsonToken.Null) return null;
            var value = serializer.Deserialize<string>(reader);
            switch (value)
...
internal class ProjectCategoryConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(ProjectCategory) || t == typeof(ProjectCategory?); public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            if (reader.TokenType == JsonToken.Null) return null;
            var value = serializer.Deserialize<string>(reader);
            switch (value)
...
internal class ProjectTypeConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(ProjectType) || t == typeof(ProjectType?); public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            if (reader.TokenType == JsonToken.Null) return null;
            var value = serializer.Deserialize<string>(reader);
            switch (value)
